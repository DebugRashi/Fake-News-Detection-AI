...
sgd_pipeline = Pipeline([
        ...
        ('svm2_clf',SGDClassifier(loss='hinge', l1_ratio=0, alpha=1e-3,max_iter=1000))
        ])
...
def build_confusion_matrix(classifier):
    ...
    for train_ind, test_ind in k_fold.split(DataPrep.train_news):
        ...
        pickle.dump(classifier, open('new_model.pkl', 'wb'))
...
sgd_pipeline_ngram = Pipeline([
         ...
         ('sgd_clf',SGDClassifier(loss='hinge',l1_ratio=0, alpha=1e-3, max_iter=1000))
         ])
